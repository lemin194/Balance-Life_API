...
urlpatterns = [
    ...
    path('accounts/<str:pk>/remove_specialist', views.remove_specialist, name='remove_specialist'),
    path('accounts/<str:pk>/remove_customer', views.remove_customer, name='remove_customer'),
